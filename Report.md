...
The internet contains vast amounts of data, but collecting and using it raises serious ethical questions. Internet data reflects the people who created it, they are often not a representative sample of humanity — certain demographics are over or under-represented, meaning bias is almost always present [2]. Another important issue is informed consent: people who post on social media, for example, may not have consented to their data being scraped and used in a machine learning model. There's the question whether using it respects the privacy and dignity of the people it represents. 
